...
def test_github(
    ...
    mock_responses.append(create_mock_response(github_repository_json))

    # Create mock languages response
    mock_responses.append(create_mock_response(github_repository_languages_json))

    # Create mock repository issues response
    mock_responses.append(create_mock_response(github_repository_issues_json))

    # Create mock webhook create response
    mock_responses.append(create_mock_response(github_webhook_create_json))
