...
@pytest.fixture()
def github_organization_repository_json() -> dict:
    return {
        "id": 243082080,
...
@pytest.fixture()
def gitlab_organization_json() -> dict:
    return {
        "id": 7468920,
        "web_url": "https://gitlab.com/groups/openwiden",
        "name": "OpenWiden",
        ...
        "full_name": "OpenWiden",
        "full_path": "openwiden",
        "created_at": "2020-03-20T22:21:39.316Z",
        "parent_id": None,
        "ldap_cn": None,
        "ldap_access": None,
        "shared_with_groups": [],
        "runners_token": "6VxnS1g7mJbensXNUn--",
        "projects": [
            {
                "id": 18579703,
                "description": None,
                "name": "Test for group 2",
                "name_with_namespace": "OpenWiden / Test for group 2",
                "path": "test-for-group-2",
                "path_with_namespace": "openwiden/test-for-group-2",
                "created_at": "2020-05-04T21:08:56.037Z",
                "default_branch": "master",
                "tag_list": [],
                "ssh_url_to_repo": "git@gitlab.com:openwiden/test-for-group-2.git",
                "http_url_to_repo": "https://gitlab.com/openwiden/test-for-group-2.git",
                "web_url": "https://gitlab.com/openwiden/test-for-group-2",
                "readme_url": "https://gitlab.com/openwiden/test-for-group-2/-/blob/master/README.md",
                "avatar_url": None,
                "forks_count": 0,
                "star_count": 0,
                "last_activity_at": "2020-05-04T21:08:56.037Z",
                "namespace": {
                    "id": 7468920,
                    "name": "OpenWiden",
                    "path": "openwiden",
                ...
                "_links": {
                    "self": "https://gitlab.com/api/v4/projects/18579703",
                    "issues": "https://gitlab.com/api/v4/projects/18579703/issues",
                    "merge_requests": "https://gitlab.com/api/v4/projects/18579703/merge_requests",
                    "repo_branches": "https://gitlab.com/api/v4/projects/18579703/repository/branches",
                    "labels": "https://gitlab.com/api/v4/projects/18579703/labels",
                    "events": "https://gitlab.com/api/v4/projects/18579703/events",
                    "members": "https://gitlab.com/api/v4/projects/18579703/members",
                },
                "packages_enabled": True,
                "empty_repo": False,
                "archived": False,
                ...
                "container_expiration_policy": {
                    ...
                    "name_regex": None,
                    "name_regex_keep": None,
                    "next_run_at": "2020-08-04T07:53:34.700Z",
                },
                "issues_enabled": True,
                "merge_requests_enabled": True,
                "wiki_enabled": True,
                ...
                "snippets_enabled": True,
                "service_desk_enabled": True,
                "service_desk_address": "incoming+openwiden-test-for-group-2-18579703-issue-@incoming.gitlab.com",
                "can_create_merge_request_in": True,
                "issues_access_level": "enabled",
                "repository_access_level": "enabled",
                "merge_requests_access_level": "enabled",
...
@pytest.fixture()
def gitlab_organization_repository_json() -> dict:
    return {
        "id": 18579703,
        "description": None,
        "name": "Test for group 2",
        ...
        "import_error": None,
        "open_issues_count": 0,
        "runners_token": "UT6dyrd5YJ6jUF341Vs5",
        "ci_default_git_depth": 50,
        "public_jobs": True,
        "build_git_strategy": "fetch",
        "build_timeout": 3600,
...
@pytest.fixture()
def gitlab_organization_member_json() -> dict:
    return {
        "id": 927868,
        "name": "stefanitsky",
        "username": "stefanitsky",
