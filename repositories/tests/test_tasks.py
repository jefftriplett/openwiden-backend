...
#         return [
#           Issue() for _ in range(self._issues_count)] + [PullRequest() for _ in range(self._pull_requests_count)
#         ]
#
#     @property
#     def issues(self):
...
#
#     def test_add_gitlab_repository_already_exists(
#     self, patched_async_task, patched_projects_get, patched_requests_get
#     ):
#         fake_repo = Repository()
